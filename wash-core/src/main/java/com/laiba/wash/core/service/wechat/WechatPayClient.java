...
public class WechatPayClient {
	...
	private String url;
	private String key;
	private String appid;// 1 公众账号ID
	private String mch_id;// 1 商户号
	// private String sub_appid = null;//子商户公众账号ID
	// private String sub_mch_id = null;//1 子商户号
	private String nonce_str;// 1 随机字符串
	private String sign;// 1 签名
	private String body;// 1 商品描述
	private String out_trade_no;// 1商户订单号
	private Integer total_fee;// 1总金额
	private String time_start;// 交易起始时间
	private String time_expire;// 交易结束时间
	// private String openid ;//用户标识
	private String notify_url;// 1通知地址
	private String trade_type;// 1交易类型
	...
	/**
	 * 必填 公众账号ID 例：wxd678efh567hg6787 说明：微信分配的公众账号ID（企业号corpid即为此appId）
	 *
	 * @param appid
	 */
	...
	/**
	 * 必填 商户号 例：1230000109 说明：微信支付分配的商户号
	 *
	 * @param mch_id
	 */
	...
	/**
	 * 子商户公众账号ID 例：wxd678efh567hg6787
	...
	// }
	/**
	 * 必填 子商户号 例：1230000109 说明：微信支付分配的子商户号
	 *
	 * @param sub_mch_id
	 */
	...
	// }
	/**
	 * 设备号 例：013467007045764 说明：终端设备号(门店号或收银设备ID)，注意：PC网页或公众号内支付请传"WEB"
	 *
	 * @param device_info
	 */
	...
	// }
	/**
	 * 必填 随机字符串 例：5K8264ILTKCH16CQ2502SI8ZNMTM67VS
	 * 说明：随机字符串，不长于32位。https://pay.weixin
	 * .qq.com/wiki/doc/api/native.php?chapter=4_3 默认值：30位长度由A-Z,0-9组成的随机串
	 * 
	 * @param nonce_str
	 */
	...
	/**
	 * 必填 签名【无需手动设值，调用时会自动计算并赋值】 例：C380BEC2BFD727A4B6845133519F3AD6 说明：签名，详见
	...
	/**
	 * 必填 商品描述 例：Ipad mini 16G 白色 说明:商品或支付单简要描述
	 *
	 * @param body
	 */
	...
	/**
	 * 商品详情 例：Ipad mini 16G 白色 说明:商品名称明细列表
	 *
	 * @param detail
	 */
	...
	// }
	/**
	 * 附加数据 例：深圳分店 说明：附加数据，在查询API和支付通知中原样返回，该字段主要用于商户携带订单的自定义数据
	 *
	 * @param attach
	 */
	...
	// }
	/**
	 * 必填 商户订单号 例：20150806125346 说明：商户系统内部的订单号,32个字符内、可包含字母,。 其他说明
	...
	/**
	 * 货币类型 默认为：CNY 人民币 例：CNY 说明：符合ISO 4217标准的三位字母代码，默认人民币：CNY 其他详见
	 * https://pay.weixin.qq.com/wiki/doc/api/native.php?chapter=4_2
	 *
	 * @param fee_type
	 */
	...
	// }
	/**
	 * 必填 总金额，必须大于0 单位：分 例：888【8元8角8分】 说明：订单总金额，单位为分
	 *
	 * @param total_fee
	 */
	...
	/**
	 * 必填 终端IP 例： 123.12.12.123 说明：APP和网页支付提交用户端ip，Native支付填调用微信支付API的机器IP。
	 * 默认值：本机内网IP
	 * 
	...
	/**
	 * 商品标记 例：WXG 说明：商品标记，代金券或立减优惠功能的参数
	 * 说明详见：https://pay.weixin.qq.com/wiki/doc/api
	 * /tools/sp_coupon.php?chapter=12_1
	 *
	 * @param goods_tag
	 */
	...
	// }
	/**
	 * 必填 通知地址（回调地址） 例：http://www.weixin.qq.com/wxpay/pay.php
	...
	/**
	 * 必填 交易类型 例：NATIVE 说明：取值如下：JSAPI，NATIVE，APP
	...
	/**
	 * 商品ID 例：12235413214070356458058
	...
	// }
	/**
	 * 指定支付方式 例：no_credit 说明：no_credit--指定不能使用信用卡支付
	 *
	 * @param limit_pay
	 */
	...
	// }
	/**
	 * 用户标识 例：oUpF8uMuAJO_M2pxb1Q9zNjWeS6o
	 * 说明：trade_type=JSAPI，此参数必传，用户在商户appid下的唯一标识
	 * 。openid如何获取，可参考https://pay.weixin
	 * .qq.com/wiki/doc/api/native.php?chapter=4_4
	 * 企业号请使用http://qydev.weixin.qq.com
	 * /wiki/index.php?title=OAuth%E9%AA%8C%E8%AF%81%E6%8E%A5%E5%8F%A3
	 * 获取企业号内成员userid
	 * ，再调用http://qydev.weixin.qq.com/wiki/index.php?title=Userid%E4
	 * %B8%8Eopenid%E4%BA%92%E6%8D%A2%E6%8E%A5%E5%8F%A3 进行转换
	 *
	 * @param openid
	 */
	// public void setOpenid(String openid) {
	...
	// }
	/**
	 * 用户子标识 例：oUpF8uMuAJO_M2pxb1Q9zNjWeS6o
	 * 说明：trade_type=JSAPI，此参数必传，用户在商户appid下的唯一标识
	 * 。openid如何获取，可参考https://pay.weixin
	 * .qq.com/wiki/doc/api/native.php?chapter=4_4
	 * 企业号请使用http://qydev.weixin.qq.com
	 ...
	 * notify_url,trade_type 不能为空或NULL，详见set方法说明 所有属性默认为null
	 * 文档地址：https://pay.weixin.qq.com/wiki/doc/api/native_sl.php?chapter=9_1
	 * 
	 * @param key
	 *            为商户的key【API密匙】
	 */
	public WechatPayClient(String key, String url, String appid, String mch_id,
			String notify_url) {
		super();
		this.key = key;
		this.url = url;
...
//		this.notify_url = notify_url;
		...
		if (null != this.requiredList) {
			for (String s : this.requiredList) {// 检查为空的值是否必填
				if (!this.map.containsKey(s)) {// 出现未包含的必填项
					throw new Exception(s + "--为必填项。请检查必填项："
							+ this.requiredList + " 是否填写正确。");
				}
	...
	public String getXml(String xmlRootElementName) throws Exception {
		...
		try {
			return new String(sbf.toString().getBytes("UTF-8"), "ISO8859-1");
	...
	private String string2MD5(String str) {
		...
		try {
			...
			byte[] md = mdTemp.digest(str.getBytes("UTF-8"));
			int j = md.length;
	...
	private String getSign() {
		...
		String[] keyArr = (String[]) this.map.keySet().toArray(
				new String[this.map.keySet().size()]);// 获取map中的key转为array
	...
	public static void main(String[] args) throws Exception {
		String keyString = "MmZMFg52bc71Melrm3Zm3fcB2jXNvgeR";
		String url = "https://api.mch.weixin.qq.com/pay/unifiedorder";
		String appid = "wxd3f8edaaba8f9d03";
		String mchId = "1487498402";
		String notify_url = "http://test.justli.xyz:8080/test/notifyUrl.action";
		WechatPayClient wechatPayClient = new WechatPayClient(keyString,
				url, appid,
				mchId, notify_url);
		wechatPayClient.setOut_trade_no(UUIDGenerator.getUUID());// 商户订单号
		wechatPayClient.setTotal_fee((int) (0.1 * 100));// 金额
		wechatPayClient.setTrade_type("NATIVE");// 交易类型1
		String body = "中文测试";
